...
interface ProductGridProps {
  onAddToCart: (productId: string, quantity: number, packSize: keyof Product['price']) => void;
}
...
const ProductGrid: React.FC<ProductGridProps> = ({ onAddToCart }) => {
  ...
  const products: Product[] = [
    {
      ...
      features: ['25g Complete Protein', 'No Added Sugar', 'Preservative Free', 'Gut Health Support'],
    ...
    },
    {
      ...
      features: ['25g Complete Protein', '100mg Natural Caffeine', 'Preservative Free', 'Gut Health Support'],
    ...
    },
    {
      ...
      features: ['All 4 Flavours', '25g Complete Protein', 'Perfect Variety', 'Great Value'],
  ...
  return (
    <section id="products" className="py-20 bg-gradient-to-br from-white via-[#F4F1E9]/30 to-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover our range of delicious protein shakes, each crafted with 25g of complete protein 
            and zero added sugar. Choose your favorite or try them all!
          </p>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <select
                ...
                className="px-4 py-3 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#688F4E] focus:border-transparent transition-all duration-300"
              >
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-[#2B463C]">Flavor</label>
                  <div className="space-y-1">
                    {['All', 'Strawberry', 'Chocolate', 'Vanilla', 'Coffee'].map((flavor) => (
                      <label key={flavor} className="flex items-center space-x-2 text-sm">
                        <input type="checkbox" className="rounded border-gray-300 text-[#688F4E] focus:ring-[#688F4E]" />
                        <span>{flavor}</span>
                      </label>
                    ))}
                  </div>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-[#2B463C]">Price Range</label>
                  <div className="space-y-1">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-[#2B463C]">Features</label>
                  <div className="space-y-1">
                    {['High Protein', 'No Sugar', 'Caffeine', 'Prebiotics'].map((feature) => (
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-2xl font-bold text-[#2B463C] mb-4">No products found</h3>
