...
const Hero: React.FC = () => {
  ...
  const slides = [
    {
      ...
      subtitle: "25g of complete protein in every bottle",
      image:
    ...
    },
    {
      ...
      subtitle: "No artificial flavors or preservatives",
      image:
    ...
    },
    {
      ...
      subtitle: "Find your favorite taste sensation",
      image:
    ...
    },
    {
      ...
      subtitle: "Healthy nutrition wherever you are",
      image:
    ...
    },
    {
      ...
      subtitle: "Formulated by nutrition experts",
      image:
  ...
  return (
    <section
      id="home"
      className="relative h-200 flex items-center justify-center overflow-hidden"
    >
      {" "}
      {/* Slider Container */}
